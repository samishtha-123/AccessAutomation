...
import freemarker.core.BuiltInsWithParseTimeParameters.switch_BI
	...
	def executeFileOperations(String Operation,String TestCaseName ,extentTest) {
		...
		switch (Operation) {
			...
			//Verify notification
				...
				println "=================================================================="
				String compressedFolderName=(new operations_FileModule.CreateFolderPageTestObj()).VerifyCompressedFile(TestCaseName,Operation)
