...
<WebElementEntity>
   ...
   <name>File_RunJob_FF</name>
   <tag></tag>
   <elementGuidId>9701e428-e7b8-4be1-a23c-9afee8fdf25a</elementGuidId>
   <selectorCollection>
      <entry>
         <key>BASIC</key>
         <value>//div[contains(@title, 'RunJob.sh') and (contains(text(), 'RunJob.sh') or contains(., 'RunJob.sh'))]</value>
      </entry>
      <entry>
         <key>XPATH</key>
