...
try
{
	...
	WebUI.click(findTestObject('JobDetailsPage/JobDetailsLink_Input'))
	extentTest.log(LogStatus.INFO,"Navigated to Details Tab")
	WebUI.click(findTestObject('FilesPage/file_RunJob'))
	extentTest.log(LogStatus.PASS,"Verified input file")
	WebUI.delay(2)
