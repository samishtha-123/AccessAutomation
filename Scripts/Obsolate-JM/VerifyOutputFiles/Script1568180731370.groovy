...
try
{
	...
	//println(WebUI.verifyElementPresent(findTestObject('JobDetailsPage/FileLink_barout'), 3))
	WebUI.verifyElementPresent(findTestObject('FilesPage/file_JobOut'), 0)
	extentTest.log(LogStatus.PASS,"Verified output file")
