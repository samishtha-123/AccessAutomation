...
try
{
	...
	TestObject newJobFilterCategoryDown = CustomKeywords.'buildTestObj.CreateTestObjFiles.myTestObjFilterCategoryIdentifierDown'(FilterCategory)

	TestObject newJobFilterCategoryRight = CustomKeywords.'buildTestObj.CreateTestObjFiles.myTestObjFilterCategoryIdentifierRight'(FilterCategory)
	...
	def result =CustomKeywords.'operations_JobsModule.GetJobRowDetails.grid'(driver, dataAttribute ,FilterValue,extentTest)
	println('=================='+result+'==========================')
