...
try
{
   ...
   //WebUI.waitForElementVisible(findTestObject('JobMonitoringPage/OutputFolder_File'), 5)
	...
	WebUI.doubleClick(findTestObject('JobMonitoringPage/OutputFolder_File'))
	
	WebUI.click(findTestObject('JobMonitoringPage/Close_button'))
	extentTest.log(LogStatus.PASS, 'Click on Close button')
	WebUI.verifyElementPresent(findTestObject('JobMonitoringPage/OutputFolder_File'), 5)
	extentTest.log(LogStatus.PASS, 'Verify file present')
