...
try
{
	    WebUI.verifyElementPresent(findTestObject('Cluster_Registration/Memory_Utilization'), 5)
		
		WebUI.verifyElementPresent(findTestObject('Cluster_Registration/Core_Utilization'), 5)
